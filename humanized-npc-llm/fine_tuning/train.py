...
def main():
    ...
    train_dataset = load_dataset("json", data_files=config['train_data_file'], split="train")
    ...
    val_dataset = load_dataset("json", data_files=config['val_data_file'], split="train") # HF loads jsonl as 'train' split
