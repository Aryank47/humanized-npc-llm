...
1. Raw data setup and parsing
    ...
    - (OPTIONAL) Then run the prepare_fine_tuning_data.py to prepare your train/val/test split or you can directly do the steps described in step 2 to get the data automatically

2. Fine Tuning data setup
    ...
    - Then to validate the npc_dialogue_records.jsonl records you can the validate_schema.py and it will print the results as per the script
